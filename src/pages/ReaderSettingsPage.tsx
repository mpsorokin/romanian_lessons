...
import { ReaderShell } from "../components/PageShell";
import { useReaderSettings } from "../features/reader-settings/ReaderSettingsProvider";
import type { ReaderSettings, ReaderTheme } from "../features/reader-settings/readerSettings.types";
...
export function ReaderSettingsPage() {
  ...
  return (
    <ReaderShell theme="paper" className="reader-settings-shell">
      ...
      <main className="reader-settings-main">
        ...
        <button className="primary-button paper-primary" type="button" onClick={save}>Сохранить</button>
      </main>
    </ReaderShell>
  );
}
